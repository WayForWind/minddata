...
#ifndef OURS_CCSRC_OURSdata_DATASET_PY_DS_CALLBACK_H
#define OURS_CCSRC_OURSdata_DATASET_PY_DS_CALLBACK_H
...
#endif  // OURS_CCSRC_OURSdata_DATASET_PY_DS_CALLBACK_H
