...
#include "dataset/include/dataset/vision.h"
#if defined(WITH_BACKEND) || defined(ENABLE_ACL) || defined(ENABLE_DVPP)
#include "dataset/include/dataset/vision_ascend.h"
#endif
#include "dataset/kernels/ir/vision/ascend_vision_ir.h"

#include "dataset/kernels/ir/vision/adjust_brightness_ir.h"
#include "dataset/kernels/ir/vision/adjust_contrast_ir.h"
#include "dataset/kernels/ir/vision/adjust_gamma_ir.h"
#include "dataset/kernels/ir/vision/adjust_hue_ir.h"
#include "dataset/kernels/ir/vision/adjust_saturation_ir.h"
#include "dataset/kernels/ir/vision/adjust_sharpness_ir.h"
#include "dataset/kernels/ir/vision/affine_ir.h"
#include "dataset/kernels/ir/vision/auto_augment_ir.h"
#include "dataset/kernels/ir/vision/auto_contrast_ir.h"
#include "dataset/kernels/ir/vision/bounding_box_augment_ir.h"
#include "dataset/kernels/ir/vision/center_crop_ir.h"
#include "dataset/kernels/ir/vision/convert_color_ir.h"
#include "dataset/kernels/ir/vision/crop_ir.h"
#include "dataset/kernels/ir/vision/cutmix_batch_ir.h"
#include "dataset/kernels/ir/vision/cutout_ir.h"
#include "dataset/kernels/ir/vision/decode_ir.h"
#ifdef ENABLE_FFMPEG
#include "dataset/kernels/ir/vision/decode_video_ir.h"
#endif
#include "dataset/kernels/ir/vision/equalize_ir.h"
#include "dataset/kernels/ir/vision/erase_ir.h"
#include "dataset/kernels/ir/vision/gaussian_blur_ir.h"
#include "dataset/kernels/ir/vision/horizontal_flip_ir.h"
#include "dataset/kernels/ir/vision/hwc_to_chw_ir.h"
#include "dataset/kernels/ir/vision/invert_ir.h"
#include "dataset/kernels/ir/vision/mixup_batch_ir.h"
#include "dataset/kernels/ir/vision/normalize_ir.h"
#include "dataset/kernels/ir/vision/normalize_pad_ir.h"
#include "dataset/kernels/ir/vision/pad_to_size_ir.h"
#include "dataset/kernels/ir/vision/perspective_ir.h"
#include "dataset/kernels/ir/vision/posterize_ir.h"
#include "dataset/kernels/ir/vision/rand_augment_ir.h"
#include "dataset/kernels/ir/vision/random_adjust_sharpness_ir.h"
#include "dataset/kernels/ir/vision/random_affine_ir.h"
#include "dataset/kernels/ir/vision/random_auto_contrast_ir.h"
#include "dataset/kernels/ir/vision/random_color_adjust_ir.h"
#include "dataset/kernels/ir/vision/random_color_ir.h"
#include "dataset/kernels/ir/vision/random_crop_decode_resize_ir.h"
#include "dataset/kernels/ir/vision/random_crop_ir.h"
#include "dataset/kernels/ir/vision/random_crop_with_bbox_ir.h"
#include "dataset/kernels/ir/vision/random_equalize_ir.h"
#include "dataset/kernels/ir/vision/random_horizontal_flip_ir.h"
#include "dataset/kernels/ir/vision/random_horizontal_flip_with_bbox_ir.h"
#include "dataset/kernels/ir/vision/random_invert_ir.h"
#include "dataset/kernels/ir/vision/random_lighting_ir.h"
#include "dataset/kernels/ir/vision/random_posterize_ir.h"
#include "dataset/kernels/ir/vision/random_resize_ir.h"
#include "dataset/kernels/ir/vision/random_resize_with_bbox_ir.h"
#include "dataset/kernels/ir/vision/random_resized_crop_ir.h"
#include "dataset/kernels/ir/vision/random_resized_crop_with_bbox_ir.h"
#include "dataset/kernels/ir/vision/random_rotation_ir.h"
#include "dataset/kernels/ir/vision/random_select_subpolicy_ir.h"
#include "dataset/kernels/ir/vision/random_sharpness_ir.h"
#include "dataset/kernels/ir/vision/random_solarize_ir.h"
#include "dataset/kernels/ir/vision/random_vertical_flip_ir.h"
#include "dataset/kernels/ir/vision/random_vertical_flip_with_bbox_ir.h"
#include "dataset/kernels/ir/vision/resize_ir.h"
#include "dataset/kernels/ir/vision/resize_preserve_ar_ir.h"
#include "dataset/kernels/ir/vision/resize_with_bbox_ir.h"
#include "dataset/kernels/ir/vision/resized_crop_ir.h"
#include "dataset/kernels/ir/vision/rgb_to_bgr_ir.h"
#include "dataset/kernels/ir/vision/rgb_to_gray_ir.h"
#include "dataset/kernels/ir/vision/rgba_to_bgr_ir.h"
#include "dataset/kernels/ir/vision/rgba_to_rgb_ir.h"
#include "dataset/kernels/ir/vision/rotate_ir.h"
#include "dataset/kernels/ir/vision/slice_patches_ir.h"
#include "dataset/kernels/ir/vision/solarize_ir.h"
#include "dataset/kernels/ir/vision/to_tensor_ir.h"
#include "dataset/kernels/ir/vision/trivial_augment_wide_ir.h"
#include "dataset/kernels/ir/vision/uniform_aug_ir.h"
#include "dataset/kernels/ir/vision/vertical_flip_ir.h"
#include "dataset/util/log_adapter.h"

#if defined(ENABLE_oursDATA_PYTHON)
#include "dataset/kernels/ir/vision/pad_ir.h"
#include "dataset/kernels/ir/vision/rescale_ir.h"
#include "dataset/kernels/ir/vision/swap_red_blue_ir.h"
#endif

#include "dataset/kernels/image/image_utils.h"
#if defined(ENABLE_FFMPEG)
#include "dataset/kernels/image/video_utils.h"
#endif
#include "dataset/kernels/ir/validators.h"

// Typecast between ours::DataType and dataset::DataType
...
// EncodeJpeg Function.
Status EncodeJpeg(const ours::OURTensor &image, ours::OURTensor *output, int quality) {
  RETURN_UNEXPECTED_IF_NULL(output);
  std::shared_ptr<dataset::Tensor> input;
  RETURN_IF_NOT_OK(Tensor::CreateFromOURTensor(image, &input));
  std::shared_ptr<dataset::Tensor> de_tensor;
  RETURN_IF_NOT_OK(ours::dataset::EncodeJpeg(input, &de_tensor, quality));
  CHECK_FAIL_RETURN_UNEXPECTED(de_tensor->HasData(),
                               "EncodeJpeg: get an empty tensor with shape " + de_tensor->shape().ToString());
  *output = ours::OURTensor(std::make_shared<DETensor>(de_tensor));
  return Status::OK();
}

// EncodePng Function.
Status EncodePng(const ours::OURTensor &image, ours::OURTensor *output, int compression_level) {
  RETURN_UNEXPECTED_IF_NULL(output);
  std::shared_ptr<dataset::Tensor> input;
  RETURN_IF_NOT_OK(Tensor::CreateFromOURTensor(image, &input));
  TensorPtr de_tensor;
  RETURN_IF_NOT_OK(ours::dataset::EncodePng(input, &de_tensor, compression_level));
  CHECK_FAIL_RETURN_UNEXPECTED(de_tensor->HasData(),
...
Status GetImageNumChannels(const ours::OURTensor &image, dsize_t *channels) {
  RETURN_UNEXPECTED_IF_NULL(channels);
  std::shared_ptr<dataset::Tensor> input;
  Status rc = Tensor::CreateFromOURTensor(image, &input);
  if (rc.IsError()) {
...
Status GetImageSize(const ours::OURTensor &image, std::vector<dsize_t> *size) {
...
// ReadFile Function.
Status ReadFile(const std::string &filename, ours::OURTensor *output) {
  RETURN_UNEXPECTED_IF_NULL(output);

  std::shared_ptr<Tensor> de_tensor;
  RETURN_IF_NOT_OK(ours::dataset::ReadFile(filename, &de_tensor));
  CHECK_FAIL_RETURN_UNEXPECTED(de_tensor->HasData(),
...
// ReadImage Function.
Status ReadImage(const std::string &filename, ours::OURTensor *output, ImageReadMode mode) {
  RETURN_UNEXPECTED_IF_NULL(output);

  std::shared_ptr<Tensor> de_tensor;
  RETURN_IF_NOT_OK(ours::dataset::ReadImage(filename, &de_tensor, mode));
  CHECK_FAIL_RETURN_UNEXPECTED(de_tensor->HasData(),
...
#ifdef ENABLE_FFMPEG
// ReadVideo Function.
Status ReadVideo(const std::string &filename, ours::OURTensor *video_output, ours::OURTensor *audio_output,
  ...
  RETURN_IF_NOT_OK(ours::dataset::ReadVideo(filename, &de_video_output, &de_audio_output, metadata_output,
                                                 start_pts, end_pts, pts_unit));
  *video_output = ours::OURTensor(std::make_shared<DETensor>(de_video_output));
  *audio_output = ours::OURTensor(std::make_shared<DETensor>(de_audio_output));
  return Status::OK();
}
...
Status ReadVideoTimestamps(const std::string &filename, std::tuple<std::vector<float>, float> *output,
  ...
  RETURN_IF_NOT_OK(
    ours::dataset::ReadVideoTimestamps(filename, &pts_int64_vector, &video_fps, &time_base, pts_unit));
...
struct ToTensor::Data {
  ...
  explicit Data(const ours::DataType &output_type)
...
ToTensor::ToTensor(ours::DataType output_type) : data_(std::make_shared<Data>(output_type)) {}
...
// WriteFile Function.
Status WriteFile(const std::string &filename, const ours::OURTensor &data) {
  std::shared_ptr<dataset::Tensor> de_tensor;
  RETURN_IF_NOT_OK(Tensor::CreateFromOURTensor(data, &de_tensor));
  RETURN_IF_NOT_OK(ours::dataset::WriteFile(filename, de_tensor));
  return Status::OK();
}

// WriteJpeg Function.
Status WriteJpeg(const std::string &filename, const ours::OURTensor &image, int quality) {
  std::shared_ptr<dataset::Tensor> image_de_tensor;
  RETURN_IF_NOT_OK(Tensor::CreateFromOURTensor(image, &image_de_tensor));
  RETURN_IF_NOT_OK(ours::dataset::WriteJpeg(filename, image_de_tensor, quality));
  return Status::OK();
}

// WritePNG Function.
Status WritePng(const std::string &filename, const ours::OURTensor &image, int compression_level) {
  std::shared_ptr<dataset::Tensor> image_de_tensor;
  RETURN_IF_NOT_OK(Tensor::CreateFromOURTensor(image, &image_de_tensor));
  RETURN_IF_NOT_OK(ours::dataset::WritePng(filename, image_de_tensor, compression_level));
  return Status::OK();
}
}  // namespace vision
}  // namespace dataset
