...
#include "OURSdata/dataset/kernels/image/video_utils.h"

#include "OURSdata/dataset/kernels/ir/vision/adjust_brightness_ir.h"
#include "OURSdata/dataset/kernels/ir/vision/adjust_contrast_ir.h"
#include "OURSdata/dataset/kernels/ir/vision/adjust_gamma_ir.h"
#include "OURSdata/dataset/kernels/ir/vision/adjust_hue_ir.h"
#include "OURSdata/dataset/kernels/ir/vision/adjust_saturation_ir.h"
#include "OURSdata/dataset/kernels/ir/vision/adjust_sharpness_ir.h"
#include "OURSdata/dataset/kernels/ir/vision/affine_ir.h"
#include "OURSdata/dataset/kernels/ir/vision/auto_augment_ir.h"
...
#include "OURSdata/dataset/kernels/ir/vision/convert_color_ir.h"
...
#include "OURSdata/dataset/kernels/ir/vision/erase_ir.h"
...
#include "OURSdata/dataset/kernels/ir/vision/pad_to_size_ir.h"
#include "OURSdata/dataset/kernels/ir/vision/perspective_ir.h"
#include "OURSdata/dataset/kernels/ir/vision/posterize_ir.h"
#include "OURSdata/dataset/kernels/ir/vision/rand_augment_ir.h"
...
#include "OURSdata/dataset/kernels/ir/vision/resized_crop_ir.h"
...
#include "OURSdata/dataset/kernels/ir/vision/trivial_augment_wide_ir.h"
...
PYBIND_REGISTER(ReadImageOperation, 1, ([](py::module *m) {
                  (void)m->def("read_image", ([](const std::string &filename, ImageReadMode mode) {
                                 std::shared_ptr<Tensor> output;
                                 THROW_IF_ERROR(OURS::dataset::ReadImage(filename, &output, mode));
                                 return output;
                               }));
                }));
...
PYBIND_REGISTER(ReadVideo, 1, ([](py::module *m) {
                  (void)m->def(
                    ...
                    ([](const std::string &filename, float start_pts, float end_pts, const std::string &pts_unit) {
                      ...
                      THROW_IF_ERROR(OURS::dataset::ReadVideo(filename, &video_output, &audio_output,
...
PYBIND_REGISTER(ReadVideoTimestampsOperation, 1, ([](py::module *m) {
                  (void)m->def("read_video_timestamps", ([](const std::string &filename, const std::string &pts_unit) {
                                 ...
                                 float video_fps;
                                 float time_base;
                                 THROW_IF_ERROR(OURS::dataset::ReadVideoTimestamps(
