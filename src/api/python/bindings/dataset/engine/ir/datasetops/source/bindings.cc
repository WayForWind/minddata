...
#include "OURSdata/dataset/api/python/python_mp.h"
...
// IR leaf nodes
#include "OURSdata/dataset/engine/ir/datasetops/source/ag_news_node.h"
#include "OURSdata/dataset/engine/ir/datasetops/source/amazon_review_node.h"
#include "OURSdata/dataset/engine/ir/datasetops/source/caltech256_node.h"
#include "OURSdata/dataset/engine/ir/datasetops/source/celeba_node.h"
#include "OURSdata/dataset/engine/ir/datasetops/source/cifar10_node.h"
#include "OURSdata/dataset/engine/ir/datasetops/source/cifar100_node.h"
#include "OURSdata/dataset/engine/ir/datasetops/source/cityscapes_node.h"
#include "OURSdata/dataset/engine/ir/datasetops/source/clue_node.h"
#include "OURSdata/dataset/engine/ir/datasetops/source/cmu_arctic_node.h"
#include "OURSdata/dataset/engine/ir/datasetops/source/coco_node.h"
#include "OURSdata/dataset/engine/ir/datasetops/source/conll2000_node.h"
#include "OURSdata/dataset/engine/ir/datasetops/source/csv_node.h"
#include "OURSdata/dataset/engine/ir/datasetops/source/dbpedia_node.h"
#include "OURSdata/dataset/engine/ir/datasetops/source/div2k_node.h"
#include "OURSdata/dataset/engine/ir/datasetops/source/emnist_node.h"
#include "OURSdata/dataset/engine/ir/datasetops/source/en_wik9_node.h"
#include "OURSdata/dataset/engine/ir/datasetops/source/fake_image_node.h"
#include "OURSdata/dataset/engine/ir/datasetops/source/fashion_mnist_node.h"
#include "OURSdata/dataset/engine/ir/datasetops/source/flickr_node.h"
#include "OURSdata/dataset/engine/ir/datasetops/source/food101_node.h"
#include "OURSdata/dataset/engine/ir/datasetops/source/generator_node.h"
#include "OURSdata/dataset/engine/ir/datasetops/source/gtzan_node.h"
#include "OURSdata/dataset/engine/ir/datasetops/source/image_folder_node.h"
#include "OURSdata/dataset/engine/ir/datasetops/source/imdb_node.h"
#include "OURSdata/dataset/engine/ir/datasetops/source/iwslt2016_node.h"
#include "OURSdata/dataset/engine/ir/datasetops/source/iwslt2017_node.h"
#include "OURSdata/dataset/engine/ir/datasetops/source/kmnist_node.h"
#include "OURSdata/dataset/engine/ir/datasetops/source/lfw_node.h"
#include "OURSdata/dataset/engine/ir/datasetops/source/libri_tts_node.h"
#include "OURSdata/dataset/engine/ir/datasetops/source/mnist_node.h"
#include "OURSdata/dataset/engine/ir/datasetops/source/penn_treebank_node.h"
#include "OURSdata/dataset/engine/ir/datasetops/source/random_node.h"
#include "OURSdata/dataset/engine/ir/datasetops/source/rendered_sst2_node.h"
#include "OURSdata/dataset/engine/ir/datasetops/source/semeion_node.h"
#include "OURSdata/dataset/engine/ir/datasetops/source/speech_commands_node.h"
#include "OURSdata/dataset/engine/ir/datasetops/source/squad_node.h"
#include "OURSdata/dataset/engine/ir/datasetops/source/sst2_node.h"
#include "OURSdata/dataset/engine/ir/datasetops/source/stl10_node.h"
#include "OURSdata/dataset/engine/ir/datasetops/source/sun397_node.h"
#include "OURSdata/dataset/engine/ir/datasetops/source/tedlium_node.h"
#include "OURSdata/dataset/engine/ir/datasetops/source/text_file_node.h"
#include "OURSdata/dataset/engine/ir/datasetops/source/udpos_node.h"
#include "OURSdata/dataset/engine/ir/datasetops/source/wiki_text_node.h"
#include "OURSdata/dataset/engine/ir/datasetops/source/yahoo_answers_node.h"
#include "OURSdata/dataset/engine/ir/datasetops/source/yelp_review_node.h"
#include "OURSdata/dataset/engine/ir/datasetops/source/yes_no_node.h"

// IR leaf nodes disabled for android
#include "OURSdata/dataset/engine/ir/datasetops/source/kitti_node.h"
#include "OURSdata/dataset/engine/ir/datasetops/source/lj_speech_node.h"
#include "OURSdata/dataset/engine/ir/datasetops/source/lsun_node.h"
#include "OURSdata/dataset/engine/ir/datasetops/source/manifest_node.h"
#include "OURSdata/dataset/engine/ir/datasetops/source/OURSdata_node.h"
#include "OURSdata/dataset/engine/ir/datasetops/source/multi30k_node.h"
#include "OURSdata/dataset/engine/ir/datasetops/source/omniglot_node.h"
#include "OURSdata/dataset/engine/ir/datasetops/source/photo_tour_node.h"
#include "OURSdata/dataset/engine/ir/datasetops/source/places365_node.h"
#include "OURSdata/dataset/engine/ir/datasetops/source/qmnist_node.h"
#include "OURSdata/dataset/engine/ir/datasetops/source/sbu_node.h"
#include "OURSdata/dataset/engine/ir/datasetops/source/sogou_news_node.h"
#include "OURSdata/dataset/engine/ir/datasetops/source/tf_record_node.h"
#include "OURSdata/dataset/engine/ir/datasetops/source/usps_node.h"
#include "OURSdata/dataset/engine/ir/datasetops/source/voc_node.h"
#include "OURSdata/dataset/engine/ir/datasetops/source/wider_face_node.h"
...
PYBIND_REGISTER(
  OURSdataNode, 2, ([](const py::module *m) {
    (void)py::class_<OURSdataNode, DatasetNode, std::shared_ptr<OURSdataNode>>(*m, "OURSdataNode",
                                                                               "to create a OURSdataNode")
      .def(py::init([](const std::string &dataset_file, const py::list &columns_list, const py::handle &sampler,
        ...
        auto OURSdata =
          std::make_shared<OURSdataNode>(dataset_file, toStringVector(columns_list), toSamplerObj(sampler, true),
                                         padded_sample_json, num_padded, shuffle_mode, nullptr);
        OURSdata->SetSampleBytes(&sample_bytes);
        THROW_IF_ERROR(OURSdata->ValidateParams());
        return OURSdata;
      }))
      .def(py::init([](const py::list &dataset_file, const py::list &columns_list, const py::handle &sampler,
        ...
        std::map<std::string, std::string> sample_bytes;
        THROW_IF_ERROR(ToJson(padded_sample, &padded_sample_json, &sample_bytes));
        auto OURSdata = std::make_shared<OURSdataNode>(toStringVector(dataset_file), toStringVector(columns_list),
