...
#include "dataset/include/dataset/text.h"

#include <fstream>
#include <regex>

#include "dataset/core/type_id.h"
#include "dataset/text/ir/kernels/text_ir.h"
...
ToNumber::ToNumber(ours::DataType data_type) : data_(std::make_shared<Data>()) {
  data_->data_type_ = dataset::MSTypeToDEType(static_cast<TypeId>(data_type));
}
