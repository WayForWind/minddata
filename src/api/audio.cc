...
#include "dataset/include/dataset/audio.h"

#include "dataset/audio/ir/kernels/allpass_biquad_ir.h"
#include "dataset/audio/ir/kernels/amplitude_to_db_ir.h"
#include "dataset/audio/ir/kernels/angle_ir.h"
#include "dataset/audio/ir/kernels/band_biquad_ir.h"
#include "dataset/audio/ir/kernels/bandpass_biquad_ir.h"
#include "dataset/audio/ir/kernels/bandreject_biquad_ir.h"
#include "dataset/audio/ir/kernels/bass_biquad_ir.h"
#include "dataset/audio/ir/kernels/biquad_ir.h"
#include "dataset/audio/ir/kernels/complex_norm_ir.h"
#include "dataset/audio/ir/kernels/compute_deltas_ir.h"
#include "dataset/audio/ir/kernels/contrast_ir.h"
#include "dataset/audio/ir/kernels/db_to_amplitude_ir.h"
#include "dataset/audio/ir/kernels/dc_shift_ir.h"
#include "dataset/audio/ir/kernels/deemph_biquad_ir.h"
#include "dataset/audio/ir/kernels/detect_pitch_frequency_ir.h"
#include "dataset/audio/ir/kernels/dither_ir.h"
#include "dataset/audio/ir/kernels/equalizer_biquad_ir.h"
#include "dataset/audio/ir/kernels/fade_ir.h"
#include "dataset/audio/ir/kernels/filtfilt_ir.h"
#include "dataset/audio/ir/kernels/flanger_ir.h"
#include "dataset/audio/ir/kernels/frequency_masking_ir.h"
#include "dataset/audio/ir/kernels/gain_ir.h"
#include "dataset/audio/ir/kernels/griffin_lim_ir.h"
#include "dataset/audio/ir/kernels/highpass_biquad_ir.h"
#include "dataset/audio/ir/kernels/inverse_mel_scale_ir.h"
#include "dataset/audio/ir/kernels/inverse_spectrogram_ir.h"
#include "dataset/audio/ir/kernels/lfcc_ir.h"
#include "dataset/audio/ir/kernels/lfilter_ir.h"
#include "dataset/audio/ir/kernels/lowpass_biquad_ir.h"
#include "dataset/audio/ir/kernels/magphase_ir.h"
#include "dataset/audio/ir/kernels/mask_along_axis_iid_ir.h"
#include "dataset/audio/ir/kernels/mask_along_axis_ir.h"
#include "dataset/audio/ir/kernels/mel_scale_ir.h"
#include "dataset/audio/ir/kernels/mel_spectrogram_ir.h"
#include "dataset/audio/ir/kernels/mfcc_ir.h"
#include "dataset/audio/ir/kernels/mu_law_decoding_ir.h"
#include "dataset/audio/ir/kernels/mu_law_encoding_ir.h"
#include "dataset/audio/ir/kernels/overdrive_ir.h"
#include "dataset/audio/ir/kernels/phase_vocoder_ir.h"
#include "dataset/audio/ir/kernels/phaser_ir.h"
#include "dataset/audio/ir/kernels/pitch_shift_ir.h"
#include "dataset/audio/ir/kernels/resample_ir.h"
#include "dataset/audio/ir/kernels/riaa_biquad_ir.h"
#include "dataset/audio/ir/kernels/sliding_window_cmn_ir.h"
#include "dataset/audio/ir/kernels/spectral_centroid_ir.h"
#include "dataset/audio/ir/kernels/spectrogram_ir.h"
#include "dataset/audio/ir/kernels/time_masking_ir.h"
#include "dataset/audio/ir/kernels/time_stretch_ir.h"
#include "dataset/audio/ir/kernels/treble_biquad_ir.h"
#include "dataset/audio/ir/kernels/vad_ir.h"
#include "dataset/audio/ir/kernels/vol_ir.h"
#include "dataset/audio/ir/validators.h"
#include "dataset/audio/kernels/audio_utils.h"
...
Status CreateDct(::OURTensor *output, int32_t n_mfcc, int32_t n_mels, NormMode norm) {
  ...
  *output = Tensor(std::make_shared<DETensor>(dct));
  return Status::OK();
}
...
Status MelscaleFbanks(OURTensor *output, int32_t n_freqs, float f_min, float f_max, int32_t n_mels, int32_t sample_rate,
  ...
  *output = Tensor(std::make_shared<DETensor>(fb));
  return Status::OK();
}
...
Status LinearFbanks(OURTensor *output, int32_t n_freqs, float f_min, float f_max, int32_t n_filter,
                    int32_t sample_rate) {
  RETURN_UNEXPECTED_IF_NULL(output);
  CHECK_FAIL_RETURN_UNEXPECTED(n_freqs > 0,
...
struct PhaseVocoder::Data {
  Data(float rate, const OURTensor &phase_advance) : rate_(rate), phase_advance_(phase_advance) {}
  float rate_;
  OURTensor phase_advance_;
};

PhaseVocoder::PhaseVocoder(float rate, const OURTensor &phase_advance)
...
std::shared_ptr<TensorOperation> PhaseVocoder::Parse() {
  ...
  Status rc = Tensor::CreateFromOURTensor(data_->phase_advance_, &phase_advance);
  if (rc.IsError()) {
