...
#ifndef OURS_CCSRC_OURSdata_DATASET_TEXT_IR_KERNELS_TEXT_IR_H_
#define OURS_CCSRC_OURSdata_DATASET_TEXT_IR_KERNELS_TEXT_IR_H_
...
#endif  // OURS_CCSRC_OURSdata_DATASET_TEXT_IR_KERNELS_TEXT_IR_H_
