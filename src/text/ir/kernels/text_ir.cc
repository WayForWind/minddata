...
#include "OURSdata/dataset/text/kernels/lookup_op.h"
#include "OURSdata/dataset/text/kernels/ngram_op.h"
#ifndef _WIN32
...
#include "OURSdata/dataset/text/kernels/to_number_op.h"
#include "OURSdata/dataset/text/kernels/to_vectors_op.h"
