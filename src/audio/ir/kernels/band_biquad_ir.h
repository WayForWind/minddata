...
#ifndef OURS_CCSRC_OURSdata_DATASET_AUDIO_IR_KERNELS_BAND_BIQUAD_IR_H_
#define OURS_CCSRC_OURSdata_DATASET_AUDIO_IR_KERNELS_BAND_BIQUAD_IR_H_
...
#endif  // OURS_CCSRC_OURSdata_DATASET_AUDIO_IR_KERNELS_BAND_BIQUAD_IR_H_
