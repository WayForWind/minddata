...
#ifndef OURS_CCSRC_OURSdata_DATASET_AUDIO_KERNELS_AUDIO_UTILS_H_
#define OURS_CCSRC_OURSdata_DATASET_AUDIO_KERNELS_AUDIO_UTILS_H_
...
#endif  // OURS_CCSRC_OURSdata_DATASET_AUDIO_KERNELS_AUDIO_UTILS_H_
