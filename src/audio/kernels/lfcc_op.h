...
#ifndef OURS_CCSRC_OURSdata_DATASET_AUDIO_KERNELS_LFCC_OP_H_
#define OURS_CCSRC_OURSdata_DATASET_AUDIO_KERNELS_LFCC_OP_H_
...
#endif  // OURS_CCSRC_OURSdata_DATASET_AUDIO_KERNELS_LFCC_OP_H_
