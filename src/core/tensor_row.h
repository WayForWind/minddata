...
#ifndef OURS_CCSRC_OURSdata_DATASET_CORE_TENSOR_ROW_H_
#define OURS_CCSRC_OURSdata_DATASET_CORE_TENSOR_ROW_H_
...
#endif  // OURS_CCSRC_OURSdata_DATASET_CORE_TENSOR_ROW_H_
