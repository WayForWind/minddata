/
#include "OURSdata/dataset/core/message_queue.h"
...
// E      File "/home/user/OURS/dataset/transforms/py_transforms_util.py", line 63, in compose
// E        args = transform(*args)
// E      File "/home/user/OURS/dataset/transforms/transforms.py", line 85, in __call__
// E        return self._execute_py(*input_tensor_list)
// E      File "/home/user/OURS/dataset/transforms/transforms.py", line 946, in _execute_py
// E        return util.random_choice(img, self.transforms)
// E      File "/home/user/OURS/dataset/transforms/py_transforms_util.py", line 171, in random_choice
// E        return random.choice(transforms)(img)
// E      File "/home/user/OURS/dataset/vision/transforms.py", line 97, in __call__
// E        return super().__call__(*input_tensor_list)
// E      File "/home/user/OURS/dataset/transforms/transforms.py", line 85, in __call__
// E        return self._execute_py(*input_tensor_list)
// E      File "/home/user/OURS/dataset/vision/transforms.py", line 4279, in _execute_py
// E        self.fill_value, Border.to_python_type(self.padding_mode))
// E      File "/home/user/OURS/dataset/vision/py_transforms_util.py", line 490, in random_crop
// E        top, left, height, width = _input_to_factor(img, size)
// E      File "/home/user/OURS/dataset/vision/py_transforms_util.py", line 472, in _input_to_factor
...
// E    ------------------------------------------------------------------
// E    OURS/ccsrc/OURSdata/dataset/engine/datasetops/map_op/map_job.h(57).
//
// ../../../build/package/OURS/dataset/engine/iterators.py:260: RuntimeError
//
...
// E      File "/home/user/OURS/dataset/transforms/py_transforms_util.py", line 199, in __call__
// E        result = self.transform(*args)
// E      File "/home/user/OURS/tests/ut/python/dataset/test_formatted_exception.py", line 125, in batch_func
// E        fake_data = 1/zero
