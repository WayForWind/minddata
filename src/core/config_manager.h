...
#ifndef OURS_CCSRC_OURSdata_DATASET_CORE_CONFIG_MANAGER_H_
#define OURS_CCSRC_OURSdata_DATASET_CORE_CONFIG_MANAGER_H_
...
#endif  // OURS_CCSRC_OURSdata_DATASET_CORE_CONFIG_MANAGER_H_
