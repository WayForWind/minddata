...
#ifndef OURS_CCSRC_OURSdata_DATASET_CORE_GLOBAL_CONTEXT_H_
#define OURS_CCSRC_OURSdata_DATASET_CORE_GLOBAL_CONTEXT_H_
...
#endif  // OURS_CCSRC_OURSdata_DATASET_CORE_GLOBAL_CONTEXT_H_
