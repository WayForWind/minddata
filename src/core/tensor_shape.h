...
#ifndef OURS_CCSRC_OURSdata_DATASET_CORE_TENSOR_SHAPE_H_
#define OURS_CCSRC_OURSdata_DATASET_CORE_TENSOR_SHAPE_H_
...
#endif  // OURS_CCSRC_OURSdata_DATASET_CORE_TENSOR_SHAPE_H_
