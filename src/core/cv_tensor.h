...
#ifndef OURS_CCSRC_OURSdata_DATASET_CORE_CV_TENSOR_H_
#define OURS_CCSRC_OURSdata_DATASET_CORE_CV_TENSOR_H_
...
#endif  // OURS_CCSRC_OURSdata_DATASET_CORE_CV_TENSOR_H_
