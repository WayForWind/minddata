...
#ifndef OURS_CCSRC_OURSdata_DATASET_ENGINE_TREE_ADAPTER_H_
#define OURS_CCSRC_OURSdata_DATASET_ENGINE_TREE_ADAPTER_H_
...
#endif  // OURS_CCSRC_OURSdata_DATASET_ENGINE_TREE_ADAPTER_H_
