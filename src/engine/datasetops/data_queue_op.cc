...
#include "OURSdata/dataset/engine/gpu_item_connector.h"
#include "OURSdata/dataset/engine/dataset_iterator.h"
#include "OURSdata/dataset/engine/datasetops/epoch_ctrl_op.h"
#include "OURSdata/dataset/util/status.h"
#include "OURSdata/dataset/util/task_manager.h"
#ifdef WITH_BACKEND
#include "OURS/ccsrc/include/backend/data_queue/data_queue_mgr.h"
    ...
    if (data->data_ != nullptr) {
      ...
      if (status != device::DataQueueStatus::SUCCESS) {
        ...
        RETURN_STATUS_ERROR(
          ...
          "2) other cases, checking info level log or search this error in our's FAQ for detail solution.");
      }
      ++send_batch;
      if (total_batch_ > 0 && send_batch >= total_batch_) {
        break;
