...
#ifndef OURS_CCSRC_OURSdata_DATASET_ENGINE_DATASETOPS_DATA_QUEUE_OP_H_
#define OURS_CCSRC_OURSdata_DATASET_ENGINE_DATASETOPS_DATA_QUEUE_OP_H_
...
#include "OURSdata/dataset/util/rdr.h"
#endif
#include "OURSdata/dataset/util/queue.h"
#include "OURSdata/dataset/util/circular_pool.h"
#include "OURS/ccsrc/include/backend/data_queue/data_queue.h"
...
using our::device::DataQueueStatus;
...
#endif  // OURS_CCSRC_OURSdata_DATASET_ENGINE_DATASETOPS_DATA_QUEUE_OP_H_
