...
#ifndef OURS_CCSRC_OURSdata_DATASET_ENGINE_DATASETOPS_SOURCE_CELEBA_OP_H
#define OURS_CCSRC_OURSdata_DATASET_ENGINE_DATASETOPS_SOURCE_CELEBA_OP_H
...
#endif  // OURS_CCSRC_OURSdata_DATASET_ENGINE_DATASETOPS_SOURCE_CELEBA_OP_H
