...
#ifndef OURS_CCSRC_OURSdata_DATASET_ENGINE_DATASET_ITERATOR_H_
#define OURS_CCSRC_OURSdata_DATASET_ENGINE_DATASET_ITERATOR_H_
...
#endif  // OURS_CCSRC_OURSdata_DATASET_ENGINE_DATASET_ITERATOR_H_
