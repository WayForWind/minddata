...
#ifndef OURS_CCSRC_OURSdata_DATASET_ENGINE_SERDES_H_
#define OURS_CCSRC_OURSdata_DATASET_ENGINE_SERDES_H_
...
#include "OURSdata/dataset/engine/ir/datasetops/batch_node.h"
#include "OURSdata/dataset/engine/ir/datasetops/concat_node.h"
...
#include "OURSdata/dataset/engine/ir/datasetops/rename_node.h"
#include "OURSdata/dataset/engine/ir/datasetops/repeat_node.h"
#include "OURSdata/dataset/engine/ir/datasetops/shuffle_node.h"
#include "OURSdata/dataset/engine/ir/datasetops/skip_node.h"
#include "OURSdata/dataset/engine/ir/datasetops/data_queue_node.h"
#include "OURSdata/dataset/engine/ir/datasetops/take_node.h"
#include "OURSdata/dataset/engine/ir/datasetops/zip_node.h"

#include "OURSdata/dataset/engine/ir/datasetops/source/album_node.h"
...
#include "OURSdata/dataset/engine/ir/datasetops/source/samplers/distributed_sampler_ir.h"
...
#include "OURSdata/dataset/engine/ir/datasetops/source/samplers/skip_first_epoch_sampler_ir.h"
...
#include "OURSdata/dataset/include/dataset/samplers.h"
...
#include "OURSdata/dataset/kernels/ir/vision/affine_ir.h"
#include "OURSdata/dataset/kernels/ir/vision/ascend_vision_ir.h"
#include "OURSdata/dataset/kernels/ir/vision/auto_contrast_ir.h"
...
#include "OURSdata/dataset/kernels/ir/vision/crop_ir.h"
...
#include "OURSdata/dataset/kernels/ir/vision/gaussian_blur_ir.h"
...
#include "OURSdata/dataset/kernels/ir/vision/mixup_batch_ir.h"
#include "OURSdata/dataset/kernels/ir/vision/normalize_ir.h"
#include "OURSdata/dataset/kernels/ir/vision/normalize_pad_ir.h"
#include "OURSdata/dataset/kernels/ir/vision/pad_ir.h"
#include "OURSdata/dataset/kernels/ir/vision/random_affine_ir.h"
#include "OURSdata/dataset/kernels/ir/vision/random_color_adjust_ir.h"
#include "OURSdata/dataset/kernels/ir/vision/random_color_ir.h"
#include "OURSdata/dataset/kernels/ir/vision/random_crop_decode_resize_ir.h"
#include "OURSdata/dataset/kernels/ir/vision/random_crop_ir.h"
#include "OURSdata/dataset/kernels/ir/vision/random_crop_with_bbox_ir.h"
...
#include "OURSdata/dataset/kernels/ir/vision/random_posterize_ir.h"
#include "OURSdata/dataset/kernels/ir/vision/random_resized_crop_ir.h"
#include "OURSdata/dataset/kernels/ir/vision/random_resized_crop_with_bbox_ir.h"
#include "OURSdata/dataset/kernels/ir/vision/random_resize_ir.h"
#include "OURSdata/dataset/kernels/ir/vision/random_resize_with_bbox_ir.h"
#include "OURSdata/dataset/kernels/ir/vision/random_rotation_ir.h"
#include "OURSdata/dataset/kernels/ir/vision/random_select_subpolicy_ir.h"
...
#include "OURSdata/dataset/kernels/ir/vision/resize_preserve_ar_ir.h"
#include "OURSdata/dataset/kernels/ir/vision/resize_with_bbox_ir.h"
...
#include "OURSdata/dataset/kernels/ir/vision/rotate_ir.h"
#include "OURSdata/dataset/kernels/ir/vision/slice_patches_ir.h"
...
#include "OURSdata/dataset/text/ir/kernels/text_ir.h"
...
class Serdes {
 public:
  ...
  static Status ParseMindIRPreprocess(const std::vector<std::string> &map_json_string,
                                      std::vector<std::shared_ptr<our::dataset::Execute>> *data_graph);
...
#endif  // OURS_CCSRC_OURSdata_DATASET_ENGINE_SERDES_H_
