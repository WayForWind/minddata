...
#ifndef OURS_CCSRC_OURSdata_DATASET_ENGINE_IR_DATASETOPS_SOURCE_DBPEDIA_NODE_H
#define OURS_CCSRC_OURSdata_DATASET_ENGINE_IR_DATASETOPS_SOURCE_DBPEDIA_NODE_H

#include <memory>
#include <string>
#include <vector>

#include "OURSdata/dataset/engine/datasetops/source/dbpedia_op.h"
...
#endif  // OURS_CCSRC_OURSdata_DATASET_ENGINE_IR_DATASETOPS_SOURCE_DBPEDIA_NODE_H_
