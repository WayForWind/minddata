...
#ifndef OURS_CCSRC_OURSdata_DATASET_ENGINE_IR_DATASETOPS_SOURCE_IWSLT2016_NODE_H_
#define OURS_CCSRC_OURSdata_DATASET_ENGINE_IR_DATASETOPS_SOURCE_IWSLT2016_NODE_H_
...
class IWSLT2016Node : public NonMappableSourceNode {
 public:
  ...
  /// \brief Destructor.
  ~IWSLT2016Node() override = default;
...
#endif  // OURS_CCSRC_OURSdata_DATASET_ENGINE_IR_DATASETOPS_SOURCE_IWSLT2016_NODE_H_
