...
#ifndef OURS_CCSRC_OURSdata_DATASET_ENGINE_IR_DATASETOPS_CONCAT_NODE_H_
#define OURS_CCSRC_OURSdata_DATASET_ENGINE_IR_DATASETOPS_CONCAT_NODE_H_
...
#endif  // OURS_CCSRC_OURSdata_DATASET_ENGINE_IR_DATASETOPS_CONCAT_NODE_H_
