...
#include "OURSdata/dataset/engine/tree_adapter.h"
...
#include "OURSdata/dataset/engine/opt/post/repeat_pass.h"
#include "OURSdata/dataset/engine/opt/pass.h"
#include "OURSdata/dataset/engine/opt/post/auto_worker_pass.h"
#ifdef ENABLE_PYTHON
#include "OURSdata/dataset/engine/opt/post/generator_node_pass.h"
#endif
#include "OURSdata/dataset/engine/opt/pre/add_skip_pass.h"

#include "OURSdata/dataset/engine/opt/pre/deep_copy_pass.h"
#include "OURSdata/dataset/engine/opt/pre/epoch_ctrl_pass.h"
...
#include "OURSdata/dataset/engine/opt/pre/node_removal_pass.h"
#include "OURSdata/dataset/engine/opt/pre/skip_pushdown_pass.h"
#include "OURSdata/dataset/engine/perf/info_collector.h"
#if !defined(__APPLE__) && !defined(_WIN32) && !defined(_WIN64)
#include "OURSdata/dataset/engine/datasetops/send_bridge_op.h"
#include "OURSdata/dataset/engine/datasetops/receive_bridge_op.h"
#include "OURSdata/dataset/core/shared_memory_queue.h"
#include "OURSdata/dataset/core/message_queue.h"
#include "OURSdata/dataset/util/gil_scoped.h"
#include "OURSdata/dataset/util/ftok_key.h"
#endif
#ifdef WITH_BACKEND
  ...
  if (independent_dataset_) {
    ...
    if (fpid < 0) {  // fork sub-process failed
      ...
      if (seed != std::mt19937::default_seed) {
        py::module::import("our.dataset.core.config").attr("set_seed")(seed);
      }
