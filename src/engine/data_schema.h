...
#ifndef OURS_CCSRC_OURSdata_DATASET_ENGINE_DATA_SCHEMA_H_
#define OURS_CCSRC_OURSdata_DATASET_ENGINE_DATA_SCHEMA_H_
...
#endif  // OURS_CCSRC_OURSdata_DATASET_ENGINE_DATA_SCHEMA_H_
