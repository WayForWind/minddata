...
#ifndef OURS_CCSRC_OURSdata_DATASET_ENGINE_OPT_PRE_ADD_SKIP_PASS_H_
#define OURS_CCSRC_OURSdata_DATASET_ENGINE_OPT_PRE_ADD_SKIP_PASS_H_
...
#endif  // OURS_CCSRC_OURSdata_DATASET_ENGINE_OPT_PRE_ADD_SKIP_PASS_H_
