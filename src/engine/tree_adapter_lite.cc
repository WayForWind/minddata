...
#include "OURSdata/dataset/engine/tree_adapter_lite.h"
#include "OURSdata/dataset/engine/ir/datasetops/root_node.h"
#include "OURSdata/dataset/engine/opt/pass.h"
#include "OURSdata/dataset/engine/opt/pre/node_offload_pass.h"
...
Status TreeAdapterLite::GetNextRow(TensorRow *const row) {
  ...
  VLOG_FLOW("Dataset Pipeline TreeAdapterLite GetNextRow finished.");
  return Status::OK();
}
