...
#ifndef OURS_CCSRC_OURSdata_DATASET_ENGINE_CONSUMERS_TREE_CONSUMER_H_
#define OURS_CCSRC_OURSdata_DATASET_ENGINE_CONSUMERS_TREE_CONSUMER_H_
...
#endif  // OURS_CCSRC_OURSdata_DATASET_ENGINE_CONSUMERS_TREE_CONSUMER_H_
