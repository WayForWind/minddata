...
#ifndef OURS_CCSRC_OURSdata_DATASET_KERNELS_IR_VALIDATORS_H_
#define OURS_CCSRC_OURSdata_DATASET_KERNELS_IR_VALIDATORS_H_
...
#endif  // OURS_CCSRC_OURSdata_DATASET_KERNELS_IR_VALIDATORS_H_
