...
#ifndef OURS_CCSRC_OURSdata_DATASET_KERNELS_IR_VISION_PAD_IR_H_
#define OURS_CCSRC_OURSdata_DATASET_KERNELS_IR_VISION_PAD_IR_H_
...
#endif  // OURS_CCSRC_OURSdata_DATASET_KERNELS_IR_VISION_PAD_IR_H_
