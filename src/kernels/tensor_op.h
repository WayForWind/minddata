...
#ifndef OURS_CCSRC_OURSdata_DATASET_KERNELS_TENSOR_OP_H_
#define OURS_CCSRC_OURSdata_DATASET_KERNELS_TENSOR_OP_H_
...
#endif  // OURS_CCSRC_OURSdata_DATASET_KERNELS_TENSOR_OP_H_
