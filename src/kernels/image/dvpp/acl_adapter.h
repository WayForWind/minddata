...
#ifndef OURS_CCSRC_OURSdata_DATASET_KERNELS_IMAGE_DVPP_ACL_ADAPTER_H_
#define OURS_CCSRC_OURSdata_DATASET_KERNELS_IMAGE_DVPP_ACL_ADAPTER_H_
...
#include "OURSdata/dataset/kernels/image/dvpp/utils/AclLiteError.h"
...
class AclAdapter {
 public:
  ...
  APP_ERROR H2D_Sink(void *acl_process, const std::shared_ptr<our::dataset::Tensor> &input,
                     std::shared_ptr<our::dataset::DeviceTensor> *device_input) const;
  APP_ERROR D2H_Pop(void *acl_process, const std::shared_ptr<our::dataset::DeviceTensor> &device_output,
                    std::shared_ptr<our::dataset::Tensor> *output) const;
  ...
  APP_ERROR CreateAclTensor(const int64_t *view_dims, uint64_t view_dims_num, our::TypeId data_type,
...
#endif  // OURS_CCSRC_OURSdata_DATASET_KERNELS_IMAGE_DVPP_ACL_ADAPTER_H_
