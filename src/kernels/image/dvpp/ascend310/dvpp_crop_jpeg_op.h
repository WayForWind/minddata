...
#ifndef OURS_CCSRC_OURSdata_DATASET_KERNELS_IMAGE_DVPP_DVPP_CROP_JPEG_OP_H_
#define OURS_CCSRC_OURSdata_DATASET_KERNELS_IMAGE_DVPP_DVPP_CROP_JPEG_OP_H_
...
#endif  // OURS_CCSRC_OURSdata_DATASET_KERNELS_IMAGE_DVPP_DVPP_CROP_JPEG_OP_H_
