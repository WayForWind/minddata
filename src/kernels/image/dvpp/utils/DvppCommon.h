...
#ifndef OURS_CCSRC_OURSdata_DATASET_KERNELS_IMAGE_DVPP_UTILS_DVPP_COMMON_H_
#define OURS_CCSRC_OURSdata_DATASET_KERNELS_IMAGE_DVPP_UTILS_DVPP_COMMON_H_
...
const uint32_t MAX_RESIZE_WIDTH = 8192;   // Max width stride of resize module
const uint32_t MAX_RESIZE_HEIGHT = 8192;  // Max height stride of resize module
...
#endif  // OURS_CCSRC_OURSdata_DATASET_KERNELS_IMAGE_DVPP_UTILS_DVPP_COMMON_H_
