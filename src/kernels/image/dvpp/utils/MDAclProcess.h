...
#ifndef OURS_CCSRC_OURSdata_DATASET_KERNELS_IMAGE_DVPP_UTILS_MD_ACL_PROCESS_H_
#define OURS_CCSRC_OURSdata_DATASET_KERNELS_IMAGE_DVPP_UTILS_MD_ACL_PROCESS_H_
...
#include "OURSdata/dataset/kernels/image/dvpp/utils/DvppCommon.h"
...
class MDAclProcess {
 public:
  ...
  APP_ERROR H2D_Sink(const std::shared_ptr<our::dataset::Tensor> &input,
                     std::shared_ptr<our::dataset::DeviceTensor> &device_input);

  APP_ERROR D2H_Pop(const std::shared_ptr<our::dataset::DeviceTensor> &device_output,
...
#endif  // OURS_CCSRC_OURSdata_DATASET_KERNELS_IMAGE_DVPP_UTILS_MD_ACL_PROCESS_H_
