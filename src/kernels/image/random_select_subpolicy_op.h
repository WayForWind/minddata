...
#ifndef OURS_CCSRC_OURSdata_DATASET_KERNELS_IMAGE_RANDOM_SELECT_SUBPOLICY_OP_
#define OURS_CCSRC_OURSdata_DATASET_KERNELS_IMAGE_RANDOM_SELECT_SUBPOLICY_OP_
...
#endif  // OURS_CCSRC_OURSdata_DATASET_KERNELS_IMAGE_RANDOM_SELECT_SUBPOLICY_OP_
