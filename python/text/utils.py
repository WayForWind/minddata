...
class JiebaMode(IntEnum):
    """
    An enumeration for :class:`.dataset.text.JiebaTokenizer` .
...
class SentencePieceVocab:
    ...
    def from_dataset(cls, dataset, col_names, vocab_size, character_coverage, model_type, params):
        ...
        Examples:
            ...
            >>> import .dataset.text as text
            >>>
            >>> from .dataset.text import SentencePieceVocab, SentencePieceModel
...
class SPieceTokenizerOutType(IntEnum):
    """
    An enumeration for :class:`.dataset.text.SentencePieceTokenizer` .
