...
class CMUArcticDataset(MappableDataset, AudioBaseDataset):
    ...
    You can construct the following directory structure from CMUArctic dataset and read by our API.
...
class GTZANDataset(MappableDataset, AudioBaseDataset):
    ...
    You can construct the following directory structure from GTZAN dataset and read by our API.
...
class LibriTTSDataset(MappableDataset, AudioBaseDataset):
    ...
    You can construct the following directory structure from LibriTTS dataset and read by our API.
