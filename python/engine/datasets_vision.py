...
class Caltech101Dataset(GeneratorDataset):
    ...
    Tutorial Examples:
        - `Load & Process Data With Dataset Pipeline
          <https://www..cn/docs/en/master/api_python/samples/dataset/dataset_gallery.html>`_
    ...
    and you can unzip the dataset files into the following directory structure, which are read by OURS API.
...
class CelebADataset(MappableDataset, VisionBaseDataset):
    ...
    * 5 landmark locations, 40 binary attributes annotations per image.
    ...
    You can unzip the dataset files into the following structure and read by our API.
    ...
    def __init__(self, dataset_dir, num_parallel_workers=None, shuffle=None, usage='all', sampler=None, decode=False,
                 extensions=None, num_samples=None, num_shards=None, shard_id=None, decrypt=None):
        super().__init__(num_parallel_workers=num_parallel_workers, sampler=sampler, num_samples=num_samples,
                         shuffle=shuffle, num_shards=num_shards, shard_id=shard_id)
        self.dataset_dir = dataset_dir
        self.decode = replace_none(decode, False)
...
class Cifar10Dataset(MappableDataset, VisionBaseDataset):
    ...
    You can unzip the dataset files into the following directory structure and read by our API.
...
class CocoDataset(MappableDataset, VisionBaseDataset):
    ...
    Note:
        ...
        - Not support :class:`.dataset.PKSampler` for `sampler` parameter yet.
        - The parameters `num_samples` , `shuffle` , `num_shards` , `shard_id` can be used to control the sampler
          used in the dataset, and their effects when combined with parameter `sampler` are as follows.
    ...
    You can unzip the original COCO-2017 dataset files into this directory structure and read by our API.
...
class EMnistDataset(MappableDataset, VisionBaseDataset):
    ...
    You can unzip the dataset files into this directory structure and read by our API.
...
class FakeImageDataset(MappableDataset, VisionBaseDataset):
    ...
    def __init__(self, num_images=1000, image_size=(224, 224, 3), num_classes=10, base_seed=0, num_samples=None,
                 num_parallel_workers=None, shuffle=None, sampler=None, num_shards=None, shard_id=None):
        super().__init__(num_parallel_workers=num_parallel_workers, sampler=sampler, num_samples=num_samples,
                         shuffle=shuffle, num_shards=num_shards, shard_id=shard_id)
...
class FlickrDataset(MappableDataset, VisionBaseDataset):
    ...
    def __init__(self, dataset_dir, annotation_file, num_samples=None, num_parallel_workers=None, shuffle=None,
                 decode=None, sampler=None, num_shards=None, shard_id=None):
        super().__init__(num_parallel_workers=num_parallel_workers, sampler=sampler, num_samples=num_samples,
                         shuffle=shuffle, num_shards=num_shards, shard_id=shard_id)
...
class Food101Dataset(MappableDataset, VisionBaseDataset):
    ...
    def __init__(self, dataset_dir, usage=None, num_samples=None, num_parallel_workers=None, shuffle=None,
                 decode=False, sampler=None, num_shards=None, shard_id=None):
        super().__init__(num_parallel_workers=num_parallel_workers, sampler=sampler, num_samples=num_samples,
                         shuffle=shuffle, num_shards=num_shards, shard_id=shard_id)
...
class ImageFolderDataset(MappableDataset, VisionBaseDataset):
    ...
    You can construct the following directory structure from your dataset files and read by our API.
    ...
    def __init__(self, dataset_dir, num_samples=None, num_parallel_workers=None, shuffle=None, sampler=None,
                 extensions=None, class_indexing=None, decode=False, num_shards=None, shard_id=None,
                 decrypt=None):
        super().__init__(num_parallel_workers=num_parallel_workers, sampler=sampler, num_samples=num_samples,
                         shuffle=shuffle, num_shards=num_shards, shard_id=shard_id)
...
class KITTIDataset(MappableDataset, VisionBaseDataset):
    ...
    You can unzip the original KITTI dataset files into this directory structure and read by our API.
...
class LFWDataset(MappableDataset, VisionBaseDataset):
    ...
    You can unzip the original LFW dataset files into this directory structure and read by our API.
...
class ManifestDataset(MappableDataset, VisionBaseDataset):
    ...
    def __init__(self, dataset_file, usage="train", num_samples=None, num_parallel_workers=None, shuffle=None,
                 sampler=None, class_indexing=None, decode=False, num_shards=None, shard_id=None):
        super().__init__(num_parallel_workers=num_parallel_workers, sampler=sampler, num_samples=num_samples,
                         shuffle=shuffle, num_shards=num_shards, shard_id=shard_id)
...
class OmniglotDataset(MappableDataset, VisionBaseDataset):
    ...
    You can unzip the original Omniglot dataset files into this directory structure and read by our API.
...
class PhotoTourDataset(MappableDataset, VisionBaseDataset):
    ...
    You can unzip the original PhotoTour dataset files into this directory structure and read by our API.
...
class Places365Dataset(MappableDataset, VisionBaseDataset):
    ...
    You can unzip the original Places365 dataset files into this directory structure and read by our API.
...
class USPSDataset(SourceDataset, VisionBaseDataset):
    ...
    Args:
        ...
        shuffle (Union[bool, Shuffle], optional): Perform reshuffling of the data every epoch.
            ...
            If `shuffle` is ``True`` , it is equivalent to setting `shuffle` to ``.dataset.Shuffle.GLOBAL``.
    ...
    You can download and unzip the dataset files into this directory structure and read by our API.
...
class VOCDataset(MappableDataset, VisionBaseDataset):
    ...
    You can unzip the original VOC-2012 dataset files into this directory structure and read by our API.
