...
def check_type_cast(method):
    ...
    def new_method(self, *args, **kwargs):
        ...
        # Check if data_type is specified dtype
...
def deprecated_c_transforms(substitute_name=None, substitute_module=None):
    """Decorator for version 1.8 deprecation warning for legacy .dataset.transforms.c_transforms operation.
    ...
    """
    return deprecator_factory("1.8", ".dataset.transforms.c_transforms", ".dataset.transforms",
                              substitute_name, substitute_module)


def deprecated_py_transforms(substitute_name=None, substitute_module=None):
    """Decorator for version 1.8 deprecation warning for legacy .dataset.transforms.py_transforms operation.

    Args:
        substitute_name (str, optional): The substitute name for deprecated operation.
        substitute_module (str, optional): The substitute module for deprecated operation.
    """
    return deprecator_factory("1.8", ".dataset.transforms.py_transforms", ".dataset.transforms",
                              substitute_name, substitute_module)
