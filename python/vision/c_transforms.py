...
class BoundingBoxAugment(ImageTensorOperation):
    ...
    Raises:
        TypeError: If `transform` is not an image processing operation
            in :class:`.dataset.vision.c_transforms` .
...
class ConvertColor(ImageTensorOperation):
    ...
    Raises:
        TypeError: If `convert_mode` is not of type :class:`.dataset.vision.c_transforms.ConvertMode` .
        RuntimeError: If given tensor shape is not <H, W> or <H, W, C>.
    ...
    Examples:
        >>> import .dataset.vision.utils as mode
...
class RandomAffine(ImageTensorOperation):
    ...
    Raises:
        ...
        TypeError: If `resample` is not of type :class:`.dataset.vision.Inter` .
        TypeError: If `fill_value` is not of type int or tuple[int].
...
class RandomCropDecodeResize(ImageTensorOperation):
    ...
    Raises:
        ...
        TypeError: If `interpolation` is not of type :class:`.dataset.vision.Inter` .
...
class SlicePatches(ImageTensorOperation):
    ...
    Raises:
        ...
        TypeError: If `slice_mode` is not of type :class:`.dataset.vision.Inter` .
...
class UniformAugment(ImageTensorOperation):
    ...
    Examples:
        >>> import .dataset.vision.py_transforms as py_vision
