...
The C++ implementation is inherited from ._c_dataengine, provides high performance
...
Examples:
    ...
    >>> from .dataset.vision import Border, Inter
...
class Affine(ImageTensorOperation):
    ...
    Examples:
        ...
        >>> import .dataset as ds
        >>> import .dataset.vision as vision
        >>> from .dataset.vision import Inter
        >>>
        >>> # Use the transform in dataset pipeline mode
        >>> data = np.random.randint(0, 255, size=(1, 100, 100, 3)).astype(np.uint8)
        >>> numpy_slices_dataset = ds.NumpySlicesDataset(data, ["image"])
...
class AutoAugment(ImageTensorOperation):
    ...
    Raises:
        TypeError: If `policy` is not of type :class:`.dataset.vision.AutoAugmentPolicy` .
    ...
    Examples:
        ...
        >>> import .dataset as ds
        >>> import .dataset.vision as vision
        >>> from .dataset.vision import AutoAugmentPolicy, Inter
        >>>
        >>> # Use the transform in dataset pipeline mode
...
class BoundingBoxAugment(ImageTensorOperation):
    ...
    Raises:
        TypeError: If `transform` is an image processing operation in `.dataset.vision` .
...
class ConvertColor(ImageTensorOperation):
    ...
    Raises:
        TypeError: If `convert_mode` is not of type :class:`.dataset.vision.ConvertMode` .
        RuntimeError: If given tensor shape is not <H, W> or <H, W, C>.
...
class CutMixBatch(ImageTensorOperation):
    ...
    Raises:
        TypeError: If `image_batch_format` is not of type :class:`.dataset.vision.ImageBatchFormat` .
    ...
    Examples:
        ...
        >>> import .dataset.transforms as transforms
        >>> import .dataset.vision as vision
        >>> from .dataset.vision import ImageBatchFormat
        >>>
        >>> # Use the transform in dataset pipeline mode
...
class DecodeVideo(VideoTensorOperation):
    ...
    Examples:
        ...
        >>> _output = vision.DecodeVideo()(raw_ndarray)
    """
...
class Pad(ImageTensorOperation, PyTensorOperation):
    ...
    Raises:
        ...
        TypeError: If `padding_mode` is not of type :class:`.dataset.vision.Border` .
...
class RandomCrop(ImageTensorOperation, PyTensorOperation):
    ...
    Examples:
        ...
        >>> import .dataset as ds
        >>> import .dataset.vision as vision
        >>> from .dataset.vision import Border
        >>>
        >>> # Use the transform in dataset pipeline mode
...
class RandomResize(ImageTensorOperation):
    """
    Resize the input image using a randomly selected :class:`.dataset.vision.Inter` interpolation method.
...
class ToTensor(ImageTensorOperation):
    ...
    Args:
        output_type (Union[.dtype, numpy.dtype], optional): The desired dtype of the output image.
            Default: ``np.float32`` .
...
class ToType(TypeCast):
    """
    Cast the input to a given  data type or NumPy data type.

    It is the same as that of :class:`.dataset.transforms.TypeCast` .
    ...
    Args:
        data_type (Union[.dtype, numpy.dtype]): The desired data type of the output image,
            such as ``numpy.float32`` .

    Raises:
        TypeError: If `data_type` is not of type :class:`.dtype` or :class:`numpy.dtype` .
