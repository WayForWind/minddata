...
class AdjustGamma(py_transforms.PyTensorOperation):
    ...
    Examples:
        >>> from .dataset.transforms.py_transforms import Compose
        >>>
...
class Normalize(py_transforms.PyTensorOperation):
    ...
    Note:
        ...
        If not so, please call :class:`.dataset.vision.py_transforms.ToTensor` first.
...
class ToType(py_transforms.PyTensorOperation):
    ...
    @deprecated_py_vision("TypeCast", ".dataset.transforms")
