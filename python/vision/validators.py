...
from ._c_dataengine import TensorOp, TensorOperation
from ._c_expression import typing
from .dataset.core.validator_helpers import check_value, check_uint8, FLOAT_MIN_INTEGER, FLOAT_MAX_INTEGER, \
...
from .dataset.transforms.validators import check_transform_op_type
...
def deprecated_c_vision(substitute_name=None, substitute_module=None):
    """Decorator for version 1.8 deprecation warning for legacy .dataset.vision.c_transforms operation.
    ...
    """
    return deprecator_factory("1.8", ".dataset.vision.c_transforms", ".dataset.vision",
                              substitute_name, substitute_module)


def deprecated_py_vision(substitute_name=None, substitute_module=None):
    """Decorator for version 1.8 deprecation warning for legacy .dataset.vision.py_transforms operation.

    Args:
        substitute_name (str, optional): The substitute name for deprecated operation.
        substitute_module (str, optional): The substitute module for deprecated operation.
    """
    return deprecator_factory("1.8", ".dataset.vision.py_transforms", ".dataset.vision",
                              substitute_name, substitute_module)
