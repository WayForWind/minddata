...
class AllpassBiquad(AudioTensorOperation):
    ...
    Tutorial Examples:
        - `Illustration of audio transforms
          <https://www..cn/docs/en/master/api_python/samples/dataset/audio_gallery.html>`_
    """
...
class AmplitudeToDB(AudioTensorOperation):
    ...
    Raises:
        TypeError: If `stype` is not of type :class:`.dataset.audio.ScaleType` .
...
class ComputeDeltas(AudioTensorOperation):
    ...
    Raises:
        ...
        TypeError: If `pad_mode` is not of type :class:`.dataset.audio.BorderType` .
        RuntimeError: If input tensor is not in shape of <..., freq, time>.
...
class Dither(AudioTensorOperation):
    ...
    Raises:
        TypeError: If `density_function` is not of type :class:`.dataset.audio.DensityFunction` .
...
class Flanger(AudioTensorOperation):
    ...
    Raises:
        ...
        TypeError: If `modulation` is not of type :class:`.dataset.audio.Modulation` .
        TypeError: If `interpolation` is not of type :class:`.dataset.audio.Interpolation` .
...
class GriffinLim(AudioTensorOperation):
    ...
    Raises:
        ...
        TypeError: If `window_type` is not of type :class:`.dataset.audio.WindowType` .
        TypeError: If `power` is not of type float.
...
class InverseMelScale(AudioTensorOperation):
    ...
    Raises:
        ...
        TypeError: If `norm` is not of type  :class:`.dataset.audio.NormType` .
        TypeError: If `mel_type` is not of type  :class:`.dataset.audio.MelType` .
...
class InverseSpectrogram(AudioTensorOperation):
    ...
    Raises:
        ...
        TypeError: If `window` is not of type :class:`.dataset.audio.WindowType` .
...
class LFCC(AudioTensorOperation):
    ...
    Args:
        ...
        speckwargs (dict, optional) : Arguments for :class:`.dataset.audio.Spectrogram`.
    ...
    Raises:
        ...
        TypeError: If `norm` is not of type :class:`.dataset.audio.NormMode` .
...
class MelSpectrogram(AudioTensorOperation):
    ...
    Raises:
        ...
        TypeError: If `window` is not of type :class:`.dataset.audio.WindowType` .
        TypeError: If `norm` is not of type :class:`.dataset.audio.NormType` .
        TypeError: If `mel_scale` is not of type :class:`.dataset.audio.MelType` .
        TypeError: If `power` is not of type float.
        TypeError: If `normalized` is not of type bool.
        TypeError: If `center` is not of type bool.
        TypeError: If `pad_mode` is not of type :class:`.dataset.audio.BorderType` .
...
class MFCC(AudioTensorOperation):
    ...
    Args:
        ...
        melkwargs (dict, optional): Arguments for :class:`.dataset.audio.MelSpectrogram`.
            Default: ``None``, the default setting is a dict including
...
class Resample(AudioTensorOperation):
    ...
    Raises:
        ...
        TypeError: If `resample_method` is not of type :class:`.dataset.audio.ResampleMethod` .
...
class Vol(AudioTensorOperation):
    ...
    Raises:
        TypeError: If `gain` is not of type float.
        TypeError: If `gain_type` is not of type :class:`.dataset.audio.GainType` .
